const events = [
    { name: "vs Kraken Beers", date: new Date("2025-03-04T20:45:00").getTime() },
    { name: "vs Green Hornets", date: new Date("2025-03-05T20:45:00").getTime() },
    { name: "vs Spartans", date: new Date("2025-03-11T20:45:00").getTime() }
